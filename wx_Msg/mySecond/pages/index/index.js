...
//获取应用实例
const app = getApp()
const APP_ID = 'wx06b03d31fcc8d335 ';//输入小程序appid  
const APP_SECRET = '26f846f670324348a2e6d189bc45e4c0 ';//输入小程序app_secret  
...
Page({
  ...
  testSubmit: function (e) {
    ...
    wx.requestSubscribeMessage({
      tmplIds: ['5U_bsCSivBtb52zCpup4tBXrZi7G4aQ9Hh73Mt2iGFk'],
      success (res) { 
